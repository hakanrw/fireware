...
var shop = [
	...
	Item.new(1 , "cv47", 270, Utils.WeaponType.PRIMARY, {"cooldown": 200, "damage": 20, "ammo": 15, "mag": 45}),
	...
	# smg
	Item.new(10, "fastgun", 1050, Utils.WeaponType.PRIMARY, {"cooldown": 200, "damage": 10, "ammo": 16, "mag": 48}),
	# heavy
	##Item.new(15, "sawn off", 1100, Utils.WeaponType.PRIMARY),
	Item.new(16, ".51 blaster", 300, Utils.WeaponType.PRIMARY, {"cooldown": 750, "damage": 50, "ammo": 2, "mag": 6}),	
	# misc
